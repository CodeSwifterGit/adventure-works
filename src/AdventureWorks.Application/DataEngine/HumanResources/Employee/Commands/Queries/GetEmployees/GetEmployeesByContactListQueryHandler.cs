...
{
    public partial class GetEmployeesByContactListQueryHandler : IRequestHandler<GetEmployeesByContactListQuery, EmployeesListViewModel>
    {
        private readonly EmployeesQueryManager _queryManager;

        public GetEmployeesByContactListQueryHandler(EmployeesQueryManager queryManager)
        {
            _queryManager = queryManager;
        }

        public async Task<EmployeesListViewModel> Handle(GetEmployeesByContactListQuery request, CancellationToken cancellationToken)
        {

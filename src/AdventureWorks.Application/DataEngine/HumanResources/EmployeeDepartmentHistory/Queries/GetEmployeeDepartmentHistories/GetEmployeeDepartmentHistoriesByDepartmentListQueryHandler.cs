...
{
    public partial class GetEmployeeDepartmentHistoriesByDepartmentListQueryHandler : IRequestHandler<GetEmployeeDepartmentHistoriesByDepartmentListQuery, EmployeeDepartmentHistoriesListViewModel>
    {
        private readonly EmployeeDepartmentHistoriesQueryManager _queryManager;

        public GetEmployeeDepartmentHistoriesByDepartmentListQueryHandler(EmployeeDepartmentHistoriesQueryManager queryManager)
        {
            _queryManager = queryManager;
        }

        public async Task<EmployeeDepartmentHistoriesListViewModel> Handle(GetEmployeeDepartmentHistoriesByDepartmentListQuery request, CancellationToken cancellationToken)
        {

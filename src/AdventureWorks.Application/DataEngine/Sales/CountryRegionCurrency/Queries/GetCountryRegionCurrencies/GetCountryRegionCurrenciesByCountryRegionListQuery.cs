...
{
    public partial class GetCountryRegionCurrenciesByCountryRegionListQuery : IRequest<CountryRegionCurrenciesListViewModel>, IDataTableInfo<CountryRegionCurrencySummary>
    {

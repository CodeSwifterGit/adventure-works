...
{
    public partial class GetCountryRegionCurrenciesByCurrencyListQuery : IRequest<CountryRegionCurrenciesListViewModel>, IDataTableInfo<CountryRegionCurrencySummary>
    {

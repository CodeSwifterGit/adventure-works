...
{
    public partial class GetSalesOrderHeadersByCustomerListQueryHandler : IRequestHandler<GetSalesOrderHeadersByCustomerListQuery, SalesOrderHeadersListViewModel>
    {
        private readonly SalesOrderHeadersQueryManager _queryManager;

        public GetSalesOrderHeadersByCustomerListQueryHandler(SalesOrderHeadersQueryManager queryManager)
        {
            _queryManager = queryManager;
        }

        public async Task<SalesOrderHeadersListViewModel> Handle(GetSalesOrderHeadersByCustomerListQuery request, CancellationToken cancellationToken)
        {

...
{
    public partial class GetSalesOrderHeadersByCreditCardListQueryHandler : IRequestHandler<GetSalesOrderHeadersByCreditCardListQuery, SalesOrderHeadersListViewModel>
    {
        private readonly SalesOrderHeadersQueryManager _queryManager;

        public GetSalesOrderHeadersByCreditCardListQueryHandler(SalesOrderHeadersQueryManager queryManager)
        {
            _queryManager = queryManager;
        }

        public async Task<SalesOrderHeadersListViewModel> Handle(GetSalesOrderHeadersByCreditCardListQuery request, CancellationToken cancellationToken)
        {

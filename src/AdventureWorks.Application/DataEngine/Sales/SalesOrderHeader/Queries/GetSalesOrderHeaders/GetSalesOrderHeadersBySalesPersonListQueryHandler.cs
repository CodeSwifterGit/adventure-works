...
{
    public partial class GetSalesOrderHeadersBySalesPersonListQueryHandler : IRequestHandler<GetSalesOrderHeadersBySalesPersonListQuery, SalesOrderHeadersListViewModel>
    {
        private readonly SalesOrderHeadersQueryManager _queryManager;

        public GetSalesOrderHeadersBySalesPersonListQueryHandler(SalesOrderHeadersQueryManager queryManager)
        {
            _queryManager = queryManager;
        }

        public async Task<SalesOrderHeadersListViewModel> Handle(GetSalesOrderHeadersBySalesPersonListQuery request, CancellationToken cancellationToken)
        {

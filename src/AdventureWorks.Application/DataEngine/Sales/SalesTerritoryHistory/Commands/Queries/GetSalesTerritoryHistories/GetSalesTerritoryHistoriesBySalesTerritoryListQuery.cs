...
{
    public partial class GetSalesTerritoryHistoriesBySalesTerritoryListQuery : IRequest<SalesTerritoryHistoriesListViewModel>, IDataTableInfo<SalesTerritoryHistorySummary>
    {

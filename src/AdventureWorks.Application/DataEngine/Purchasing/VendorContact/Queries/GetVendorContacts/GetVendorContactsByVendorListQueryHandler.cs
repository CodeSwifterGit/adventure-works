...
{
    public partial class GetVendorContactsByVendorListQueryHandler : IRequestHandler<GetVendorContactsByVendorListQuery, VendorContactsListViewModel>
    {
        private readonly VendorContactsQueryManager _queryManager;

        public GetVendorContactsByVendorListQueryHandler(VendorContactsQueryManager queryManager)
        {
            _queryManager = queryManager;
        }

        public async Task<VendorContactsListViewModel> Handle(GetVendorContactsByVendorListQuery request, CancellationToken cancellationToken)
        {

...
{
    public partial class GetVendorContactsByContactTypeListQueryHandler : IRequestHandler<GetVendorContactsByContactTypeListQuery, VendorContactsListViewModel>
    {
        private readonly VendorContactsQueryManager _queryManager;

        public GetVendorContactsByContactTypeListQueryHandler(VendorContactsQueryManager queryManager)
        {
            _queryManager = queryManager;
        }

        public async Task<VendorContactsListViewModel> Handle(GetVendorContactsByContactTypeListQuery request, CancellationToken cancellationToken)
        {

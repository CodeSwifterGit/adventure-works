...
{
    public partial class GetProductVendorsByUnitMeasureListQueryHandler : IRequestHandler<GetProductVendorsByUnitMeasureListQuery, ProductVendorsListViewModel>
    {
        private readonly ProductVendorsQueryManager _queryManager;

        public GetProductVendorsByUnitMeasureListQueryHandler(ProductVendorsQueryManager queryManager)
        {
            _queryManager = queryManager;
        }

        public async Task<ProductVendorsListViewModel> Handle(GetProductVendorsByUnitMeasureListQuery request, CancellationToken cancellationToken)
        {

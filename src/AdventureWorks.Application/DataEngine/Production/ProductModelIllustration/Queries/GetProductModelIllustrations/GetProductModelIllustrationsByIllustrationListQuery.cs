...
{
    public partial class GetProductModelIllustrationsByIllustrationListQuery : IRequest<ProductModelIllustrationsListViewModel>, IDataTableInfo<ProductModelIllustrationSummary>
    {

...
{
    public partial class UpdateProductCostHistoryCommandValidator : AbstractValidator<UpdateProductCostHistoryCommand>
    {
        public UpdateProductCostHistoryCommandValidator()
        {

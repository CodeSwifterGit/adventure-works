...
{
    public partial class UpdateTransactionHistoryArchiveCommandValidator : AbstractValidator<UpdateTransactionHistoryArchiveCommand>
    {
        public UpdateTransactionHistoryArchiveCommandValidator()
        {

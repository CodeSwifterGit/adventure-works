...
const components = [AppLoaderComponent, ConfirmationDialogComponent, ToastMessageComponent];
...
@NgModule({
  ...
  providers: [],
  exports: [components, NgScrollbarModule, SharedDirectivesModule, SharedPipesModule],
})

...
const directives = [FontSizeDirective, ScrollToDirective, NoRightClickDirective, NoCopyPasteDirective, PreventKeysDirective, PreventCharactersDirective, AllowTabDirective];

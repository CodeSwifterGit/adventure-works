...
namespace AdventureWorks.Web.Api
{
    public static class Program
    {
        public static void Main(string[] args)
        {
            ...
            try
            {
                var startupMessage = $"Starting up AdventureWorks.Web.Api, version {informationalVersion}";
        ...
        private static IWebHost BuildHost(string[] args)
        {
            ...
            {
                var context = scope.ServiceProvider.GetService<IAdventureWorksContext>();
                // ReSharper disable once PossibleNullReferenceException
                context.UpgradeDatabase();

                var seeder = scope.ServiceProvider.GetService<AdventureWorksSeeder>();
                // ReSharper disable once PossibleNullReferenceException
